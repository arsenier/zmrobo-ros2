...
{
	public:
		turn_on_robot(const rclcpp::Node::SharedPtr & node_ptr);  //Constructor //构造函数
	...
	private:
		...
		rclcpp::Subscription<ackermann_msgs::msg::AckermannDriveStamped>::SharedPtr Akm_cmd_Vel_Sub; //Initialize the topic subscriber //初始化话题订阅者
